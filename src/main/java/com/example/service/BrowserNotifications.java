...
/*import me.przepiora.vaadin.flow.browsernotifications.BrowserNotifications;
import me.przepiora.vaadin.flow.browsernotifications.BrowserNotifications.PermissionLevel;
import me.przepiora.vaadin.flow.browsernotifications.BrowserNotifications.ReportListener;*/
...
public class BrowserNotifications {
    ...
    private static String loadJS(String jsFileName) {
        InputStream resourceAsStream = BrowserNotifications.class
            .getResourceAsStream(jsFileName + ".js");
        try {
